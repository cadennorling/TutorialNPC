...
public class NPCDataManager {
    ...
    public void loadNPCs() {
        ...
        plugin.getLogger().info("Loaded " + npcs.size() + " tutorial NPC(s). Mappings: " + debugMappings());
    }
    ...
    public String debugMappings() {
        ...
        citizensIdMap.forEach((k, v) -> sb.append(k).append("->npcId:").append(v.getId()).append("(").append(v.getName()).append("), "));
        sb.append("}");
        return sb.toString();
    }
