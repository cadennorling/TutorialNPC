...
public class DatabaseManager {
    ...
    public void setProgress(UUID uuid, int index) {
        ...
        // When setting progress forward, we should also clear completed NPCs that are ahead
        // Just update the index and let natural flow handle the rest
    }
}
